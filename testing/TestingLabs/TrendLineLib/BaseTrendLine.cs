...
namespace TrendLineLib
{
    ...
    {
        public abstract IEnumerable<WeightPoint>? GetLinePoints(IEnumerable<WeightPoint> points);
        public abstract double F(double x);

        public IEnumerable<double> GetCoefs(IEnumerable<WeightPoint> points)
        {
        ...
        protected List<double> LeastSquares(List<WeightPoint> points, int power)
        {
            int n = points.Count;
        ...
        protected int GetExtremumsCount(List<WeightPoint> points)
        {
            int extremums = 0;
